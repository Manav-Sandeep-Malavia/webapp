...
#   post-processor "ami" {
#     name = "demo-debian-12"
#     users = ["518683749434"] # Replace with your DEMO AWS account ID
#     launch_permissions {
#       user_ids = ["518683749434"] # Replace with your DEMO AWS account ID
#     }
#   }
packer {
  required_plugins {
...
# This is where post-processing can be done outside the "build" block.
# You can add your post-processors here.
